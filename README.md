---
# Mac Version of EZ-FRCNN: A Fast, Accessible and Robust Deep Learning Package for Object Detection Applications in Ethology and Cell Biology
**Read the preprint on [bioRxiv](https://doi.org/10.1101/2025.06.19.660198).**
...
1. Navigate to our [main branch of this repository](https://github.com/JacobWheelock/ez-frcnn/).
2. Install [Docker for Windows](https://docs.docker.com/desktop/setup/install/windows-install/).
3. Launch Docker Desktop.
4. [Download](https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/JacobWheelock/ez-frcnn) or clone this repository as shown below.
   ```
...
## Installation (MacOS)
1. Install [Docker for MacOS](https://docs.docker.com/desktop/install/mac-install/).
2. Launch Docker Desktop.
3. [Download](https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/JacobWheelock/ez-frcnn/tree/mac) or clone the [Mac branch of this repository](https://github.com/JacobWheelock/ez-frcnn/tree/mac) as shown below.
    ```
...
5. Double-click `ez-frcnn.command` to launch EZ-FRCNN. OR for a **more user-friendly experience**, double-click `ez-frcnnPane.command` to launch the GUI.
